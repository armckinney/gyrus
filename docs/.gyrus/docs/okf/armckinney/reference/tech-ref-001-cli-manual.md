---
id: tech-ref-001-cli-manual
title: Gyrus CLI Subcommand Reference Manual
category: technical
...
### 7. `gyrus archive <id>`
Archives (deletes) a document payload from storage and search index.

```bash
gyrus archive adr-001-storage [--json]
```
